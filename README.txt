================================================================================
                FileDeduper  ·  文件查重清理助手 v2.1 preview 3 Lite
================================================================================
...
【当前版本】
v2.1.0-preview.3 Lite

更新重点：
  ✓ 关于窗口和主窗口标题显示版本号，便于区分桌面测试包
  ✓ README 增加版本更新/修复记录
  ✓ 保留 preview 2 的哈希并行度、GPU fallback、benchmark 能力
...
✓ 加速路线：轻量版不依赖 GPU；GPU 支持版未来作为独立发布包
